...
;hljs.registerLanguage("csharp",e)})();/*! `javascript` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict"
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `asciidoc` grammar compiled for Highlight.js 11.6.0 */
